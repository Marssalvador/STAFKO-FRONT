...
export const PoliticaPrivacidad = () => {
  return (
    <div>
        <p>Política de privacidad de STAFKO

            Esta Política de privacidad describe cómo se recopila, utiliza y comparte su información personal cuando visita o hace una compra en www.stafko.com (denominado en lo sucesivo el “Sitio”).
            ...
            Calle Stafko, N1, Granada, C, 18012, España</p>
    </div>
  )
}
